...
storiesOf('Forms', module)
    ...
    .add('Select input with templateDisplay', () => <SelectInput elements={[{ group: '', items: [{ text: 'First item', value: 0 }, { text: 'Second item', value: 1 }, { text: 'Third item', value: 2 }] }]} templateDisplay={item => <div>{`!!! ${item.text} !!!`}</div>} />)
    .add('Select input with templateHeader', () => <SelectInput elements={[{ group: 'Group', items: [{ text: 'First item', value: 0 }, { text: 'Second item', value: 1 }, { text: 'Third item', value: 2 }] }]} templateHeader={item => <div>{`!!! ${item.text} !!!`}</div>} />)
    .add('Select input with templateItem', () => <SelectInput elements={[{ group: '', items: [{ text: 'First item', value: 0 }, { text: 'Second item', value: 1 }, { text: 'Third item', value: 2 }] }]} templateItem={item => <div>{`!!! ${item.text} !!!`}</div>} />)
    .add('Select input disabled', () => <SelectInput elements={[{ group: '', items: [{ text: 'First item', value: 0 }, { text: 'Second item', value: 1 }, { text: 'Third item', value: 2 }] }]} disabled />)
