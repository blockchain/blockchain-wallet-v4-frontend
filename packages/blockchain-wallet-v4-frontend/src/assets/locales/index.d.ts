...
type MessagesType = {
  ...
  'scenes.login.upgrade.2.0.header': 'Upgrade to a Unified Account'
  'scenes.login.upgrade.2.0.item_1.title': 'Blockchain.com Wallet'
  'scenes.login.upgrade.2.0.item_1.text': 'Self custody your funds in the world’s most popular crypto wallet.'
  'scenes.login.upgrade.2.0.item_2.title': 'Simplified Login'
  'scenes.login.upgrade.2.0.item_2.text': 'Easily access the Wallet and Exchange with the same credentials.'
  'scenes.login.upgrade.2.0.item_3.title': 'Enhanced Security'
  'scenes.login.upgrade.2.0.item_3.text': 'Protect your investments across both accounts with two-factor authentication.'
  'scenes.login.upgrade.2.0.item_4.title': 'Full Portfolio Access'
  'scenes.login.upgrade.2.0.item_4.text': 'View and manage all your funds across both the Wallet and Exchange.'
  'scenes.login.upgrade.2.0.button_1': 'Upgrade My Account'
  'scenes.login.upgrade.2.0.button_2': 'I´ll Do This'
  'scenes.login.upgrade.3.0.header': 'What´s Next'
  'scenes.login.upgrade.3.0.upgrading_accounts': 'Upgrading Accounts'
  'scenes.login.upgrade.3.0.item_1.title': 'Create a New Password'
  'scenes.login.upgrade.3.0.item_1.text': 'This new password will allow you to log into your Wallet and Exchange accounts with the same email and password.'
  'scenes.login.upgrade.3.0.item_2.title': 'Create a New 2FA'
  'scenes.login.upgrade.3.0.item_2.text': 'This new 2FA method will replace your old Exchange 2FA. You will use this for 2FA on the Wallet and Exchange.'
  'scenes.login.upgrade.3.0.item_3.title': 'You’re All Set!'
  'scenes.login.upgrade.3.0.item_3.text': 'You’ll get a confirmation email. Use your email, new password, and new 2FA to log in to the Wallet or Exchange.'
  'scenes.login.upgrade.3.0.button': 'Next'
  'scenes.login.upgrade.3.1.1.header': 'Something Didn´t Work'
  'scenes.login.upgrade.3.1.1.text': 'Don’t worry, you can still login with original credentials. You can retry the upgrade the next time you login.'
  'scenes.login.upgrade.3.1.1.button': 'Open Exchange'
  'scenes.login.upgrade.3.1.1.steps': 'Steps {actualStep} of {totalSteps}'
  'scenes.login.upgrade.3.1.2.header': 'Something Didn’t Work'
  'scenes.login.upgrade.3.1.2.text': 'Don’t worry, you can still login with original credentials. You can retry the upgrade the next time you login.'
  'scenes.login.upgrade.3.1.2.button_1': 'Retry Upgrade'
  'scenes.login.upgrade.3.1.2.button_2': 'I’ll Try Again Later'
  'scenes.login.upgrade.3.2.header': 'Set Up 2FA'
  'scenes.login.upgrade.3.2.text': 'Protect your accounts from unauthorized access by enabling 2FA. When you access your Blockchain account, enter your Google Auth code or insert a YubiKey.'
  'scenes.login.upgrade.3.2.item_1.title': 'Google Authenticator'
  'scenes.login.upgrade.3.2.item_1.text': 'Generate a second step of verification when you sign in.'
  'scenes.login.upgrade.3.2.item_2.title': 'YubiKey'
  'scenes.login.upgrade.3.2.item_2.text': 'Secure your wallet with a physical key or device.'
