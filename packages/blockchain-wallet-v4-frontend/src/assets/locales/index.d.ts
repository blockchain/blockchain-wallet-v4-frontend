...
type MessagesType = {
  ...
  'modals.brokerage.authorize.about_access': '{entityName} will then use these details with Blockchain solely for the purposes of buying cryptocurrencies. This consent request is a one-off, you will not receive additional requests once completed.'
