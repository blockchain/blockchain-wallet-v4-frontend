...
type MessagesType = {
  ...
  'modal.complete_profile.finish_settings': 'Finish setting up your Blockchian.com account and start buying crypto today.'
  ...
  'scenes.login.wallet.mobile_app_login.title': 'Or Log in with Mobile App'
  'scenes.login.wallet.mobile_login.description_one': 'Scan this QR code with the Blockchain.com mobile app.'
  'scenes.login.wallet.mobile_login.description.ios': '<b>iOS</b> - Tap the Menu button at the top left corner of the app to reveal Web Log In option.'
  'scenes.login.wallet.mobile_login.description.android': '<b>Android</b> - Tap the QR code icon at the top right corner of the app.'
