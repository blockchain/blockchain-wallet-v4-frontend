...
type MessagesType = {
  ...
  'modals.interest.deposit.calcdesc': 'With {currencySymbol}{depositAmount} in your Interest Account you could earn:'
  'modals.interest.deposit.confirm': 'Confirm Deposit'
  'modals.interest.deposit.agreement': 'By accepting this, you agree to transfer {currencySymbol} {fiatValue} ({depositAmountCrypto} {coinTicker}) from your wallet to your Interest Account. A lock-up period of 7 days will be applied to your funds.'
  ...
  'modals.interest.deposit.failure': 'Something went wrong when sending your deposit. Please try again later or contact support if the issue persists.'
  'modals.interest.deposit.failurereason': 'Error: {error}'
  'modals.interest.deposit.success': 'Your deposit has been sent to your Interest Account. Your balance will update once the transaction is confirmed by the network.  No further action is required.'
  ...
  'modals.interest.deposit.year': 'Year'
