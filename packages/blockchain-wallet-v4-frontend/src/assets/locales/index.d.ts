...
type MessagesType = {
  ...
  'buttons.add_coin': 'Add {displayName}'
  ...
  'buttons.withdraw_coin': 'Withdraw {displayName}'
  ...
  'components.alerts.verify_email_sent_error_try_again': 'Error sending verification email. Please try again.'
  ...
  'copy.bank_linked_error_account_invalid': "You've tried to link an invalid account. Please try another account or"
  'copy.bank_linked_error_account_expired': 'We were unable to link your account.'
  'copy.bank_linked_error_account_failed': 'The request to pair your account has timed out. Try pairing your account again. If this keeps happening, please'
  'copy.bank_linked_error_account_rejected': "We believe you have declined linking your account. If this isn't correct, please"
  'copy.bank_linked_error_rejected_fraud': 'Please try again or select a different payment method.'
  'copy.bank_linked_error_title_already_linked': 'This account is already linked.'
  'copy.bank_linked_error_title_account_invalid': 'Invalid Account'
  'copy.bank_linked_error_title_connectionrejected': 'Connection Rejected'
  'copy.bank_linked_error_title_expiredaccount': 'We were unable to link your account.'
  'copy.bank_linked_error_title_expiredaccount.desc': 'Please try connecting that bank account again or link any Visa or Mastercard'
  ...
  'copy.bank_linked_error_title_rejected_fraud': 'There was a problem linking your account.'
  'copy.bank_link_current_account': 'Please link a Current Account.'
  'copy.bank_link_current_account_extra_fees': 'Your bank may charge you extra fees if you buy crypto without a current account.'
  ...
  'copy.swap_get_limited_access': 'Get access to swap in seconds by completing your profile and getting limited access.'
  'copy.swap_available_in_wallet': 'Your {coin} is now available in your Wallet.'
  ...
  'copy.try_another_method': 'Try another method'
  'copy.trading_account_access': 'Get Trading Account access'
  'copy.trading_get_limited_access': 'Get access to the Trading Account in seconds by completing your profile and getting limited access.'
  ...
  'identityverification.extra_fields.title': 'Use of Account Information'
  'identityverification.extra_fields.select_all': '(Select all that apply)'
  'identityverification.extra_fields.select_one': '(Select only one)'
  'identityverification.extra_fields.question1.title': 'Nature & Purpose of Business Relationship'
  'identityverification.extra_fields.question1.option1': 'Buy cryptocurrency with cards or bank transfer'
  'identityverification.extra_fields.question1.option2': 'Swap my cryptocurrencies'
  'identityverification.extra_fields.question1.option3': 'Send Cryptocurrencies to family or friends'
  'identityverification.extra_fields.question1.option4': 'Online Purchases'
  'identityverification.extra_fields.question1.option5': 'Business'
  'identityverification.extra_fields.question2.title': 'Source of Funds'
  'identityverification.extra_fields.question3.title': 'Are You Acting On Your Behalf?'
  'identityverification.extra_fields.question4.title': 'Are you a Politically Exposed Person (PEP)?'
  'identityverification.extra_fields.question4.option1': 'No'
  'identityverification.extra_fields.question4.option2': 'Yes, I Am'
  'identityverification.extra_fields.question4.option3': 'Yes, My Family Member Or Close Associate Is'
  'identityverification.extra_fields.question4.full_name': 'Full Name'
  'identityverification.extra_fields.question4.relationship': 'Their Relationship To You'
  'identityverification.failure.button': 'Start Trading'
  'identityverification.failure.content_1': "We're sorry but we can't verify you for full access at this time. This can be for a number of reasons, for example your country might not be supported right now. If you have limited access you can still Buy, Sell or Swap a limited amount of crypto now."
  ...
  'modals.entity_migration.description': 'Starting later this month, UK customers will be served by our European subsidiary, Blockchain (LT), UAB. You will not experience any changes in user experience or lose access to your funds during this transition. <a>Learn more.</a>'
  ...
  'modals.interest.deposit.title_add': 'Add {displayName}'
  ...
  'modals.onboarding.linktoexchangeaccount.na.right.topoint_access': 'Share your full or limited access'
  ...
  'modals.onboarding.upgrade_now.description': 'Verify your identity and unlock access to Buying, Selling, Swapping & Rewards Accounts.'
  'modals.onboarding.upgrade_now.disclaimer': 'Verified level includes all basic level features'
  'modals.onboarding.upgrade_now.disclaimer_full_access': 'Full Access includes all limited access features'
  'modals.onboarding.upgrade_now.title': 'Upgrade Your Account.'
  'modals.onboarding.upgrade_now.basic_level': 'Basic Level'
  'modals.onboarding.upgrade_now.send_and_receive_crypto': 'Send & Receive Crypto'
  'modals.onboarding.upgrade_now.between_private_key_wallets': 'Between Private Key Wallets'
  'modals.onboarding.upgrade_now.one_time_between_private_key_wallets': 'One-Time Between Private Key Wallets'
  'modals.onboarding.upgrade_now.full_access': 'Full Access'
  'modals.onboarding.upgrade_now.verified_level': 'Verified Level'
  'modals.onboarding.upgrade_now.between_all_wallets_and_accounts': 'Between All Wallets & Accounts'
  'modals.onboarding.upgrade_now.buying_and_selling': 'Buying & Selling'
  'modals.onboarding.upgrade_now.card_or_banking_methods': 'Card or Banking Methods'
  'modals.onboarding.upgrade_now.earn_rewards_on_your_crypto': 'Earn Rewards On Your Crypto'
  'modals.onboarding.upgrade_now.upgrade_and_unlock': 'Upgrade & Unlock'
  'modals.onboarding.upgrade_now.title_second': 'Buy, Sell & Swap More Crypto.'
  'modals.onboarding.upgrade_now.limited_access': 'Limited Access'
  'modals.onboarding.upgrade_now.apply_now': 'Apply Now'
  'modals.onboarding.upgrade_now.get_limited_access': 'Get Limited Access'
  'modals.onboarding.upgrade_now.get_basic': 'Get Basic'
  'modals.onboarding.upgrade_now.get_verified': 'Get Verified'
  'modals.onboarding.upgrade_now.get_full_access': 'Get Full Access'
  ...
  'modals.onboarding.upgrade_now.rewards_accounts': 'Rewards Accounts'
  'modals.onboarding.upgrade_now.account_limits': 'Account Limits'
  ...
  'modals.simplebuy.checkout.buy.over_limit_full_access': 'You can buy up to {amount} per transaction. Get full access & buy larger amounts with your bank or card.'
  ...
  'modals.simplebuy.checkout.sell_max_amount': 'You can buy up to {amount} per transaction. Get full access & buy larger amounts with your bank or card.'
  ...
  'modals.simplebuy.checkout.larger_amount.info_full_access': 'After completing this transaction, get full access to unlock higher transaction limits and more payment methods.'
  ...
  'modals.simplebuy.withdrawal.withdrawal_button': 'Withdraw Now'
  ...
  'modals.terms_and_conditions.title': 'Review Our New Terms'
  'modals.terms_and_conditions.confirm_label': 'I agree to Blockchain.com’s <a>Terms of Service & Privacy Policy.</a>'
  'modals.trade.buy.description': 'Use Your Cash or Card'
  'modals.trade.header': 'Shortcuts'
  'modals.trade.sell.description': 'Convert Your Crypto to Cash'
  ...
  'modals.tradinglimits.per_day': 'Per Day'
  'modals.tradinglimits.per_month': 'Per Month'
  'modals.tradinglimits.per_year': 'Per Year'
  'modals.tradinglimits.no_limit': 'No limit'
  ...
  'modals.tradinglimits.upgrade.tier.full_access.title': 'Upgrade to Full Access'
  ...
  'modals.tradinglimits.upgrade.limited_access_limits': 'Limited Access Limits'
  'modals.tradinglimits.upgrade.full_access_limits': 'Full Access Limits'
  ...
  'modals.upgradenow.unlock_full_access_limits': 'Unlock Full Access'
  ...
  'scenes.exchange.empty.carousel.unlockbody': 'Already Verified? Share your full or limited access to begin trading on the Exchange immediately.'
  ...
  'scenes.home.banner.continue_to_full_access.button': 'Continue to Full Access'
  'scenes.home.banner.continue_to_full_access.description': 'Continue your verification to become full access and increase your limits and payment methods'
  ...
  'scenes.home.banners.transaction_left.title': 'Transaction Left'
  'scenes.home.banners.transactions_left.title': 'Transactions Left'
  'scenes.home.banners.transaction_left.description': 'Unlimited trades and higher limits'
  ...
  'scenes.interest.earnupgrade.full_access.header': 'Upgrade to full access so you can earn rewards on your crypto.'
  ...
  'scenes.interest.kyc_under_review': 'Full Access Verification In Review'
  ...
  'scenes.login.upgrade.upsell.header': 'Upgrade to a Unified Account'
  'scenes.login.upgrade.upsell.item_1.title': 'Blockchain.com Wallet'
  'scenes.login.upgrade.upsell.item_1.text': 'Self custody your funds in the world’s most popular crypto wallet.'
  'scenes.login.upgrade.upsell.item_2.title': 'Simplified Login'
  'scenes.login.upgrade.upsell.item_2.text': 'Easily access the Wallet and Exchange with the same credentials.'
  'scenes.login.upgrade.upsell.item_3.title': 'Enhanced Security'
  'scenes.login.upgrade.upsell.item_3.text': 'Protect your investments across both accounts with two-factor authentication.'
  'scenes.login.upgrade.upsell.item_4.title': 'Full Portfolio Access'
  'scenes.login.upgrade.upsell.item_4.text': 'View and manage all your funds across both the Wallet and Exchange.'
  'scenes.login.upgrade.upsell.button_1': 'Upgrade My Account'
  'scenes.login.upgrade.upsell.button_2': 'I´ll Do This'
  'scenes.login.upgrade.next_steps.header': 'What´s Next'
  'scenes.login.upgrade.next_steps.upgrading_accounts': 'Upgrading Accounts'
  'scenes.login.upgrade.next_steps.item_1.title': 'Create a New Password'
  'scenes.login.upgrade.next_steps.item_1.text': 'This new password will allow you to log into your Wallet and Exchange accounts with the same email and password.'
  'scenes.login.upgrade.next_steps.item_2.title': 'Create a New 2FA'
  'scenes.login.upgrade.next_steps.item_2.text': 'This new 2FA method will replace your old Exchange 2FA. You will use this for 2FA on the Wallet and Exchange.'
  'scenes.login.upgrade.next_steps.item_3.title': 'You’re All Set!'
  'scenes.login.upgrade.next_steps.item_3.text': 'You’ll get a confirmation email. Use your email, new password, and new 2FA to log in to the Wallet or Exchange.'
  'scenes.login.upgrade.unable_retry.header': 'Something Didn´t Work'
  'scenes.login.upgrade.unable_retry.text': 'Don’t worry, you can still login with original credentials. You can retry the upgrade the next time you login.'
  'scenes.login.upgrade.unable_retry.button': 'Open Exchange'
  'scenes.login.upgrade.unable_retry.steps': 'Steps {actualStep} of {totalSteps}'
  'scenes.login.upgrade.able_retry.header': 'Something Didn’t Work'
  'scenes.login.upgrade.able_retry.text': 'Don’t worry, you can still login with original credentials. You can retry the upgrade the next time you login.'
  'scenes.login.upgrade.able_retry.button_1': 'Retry Upgrade'
  'scenes.login.upgrade.able_retry.button_2': 'I’ll Try Again Later'
  'scenes.login.upgrade.2fa.header': 'Set Up 2FA'
  'scenes.login.upgrade.2fa.text': 'Protect your accounts from unauthorized access by enabling 2FA. When you access your Blockchain account, enter your Google Auth code or insert a YubiKey.'
  'scenes.login.upgrade.2fa.item_1.title': 'Google Authenticator'
  'scenes.login.upgrade.2fa.item_1.text': 'Generate a second step of verification when you sign in.'
  'scenes.login.upgrade.2fa.item_2.title': 'YubiKey'
  'scenes.login.upgrade.2fa.item_2.text': 'Secure your wallet with a physical key or device.'
  'scenes.login.upgrade.googleAuth.header': 'Set Up 2FA'
  'scenes.login.upgrade.googleAuth.text': 'With your Google Authenticator app, scan the QR code below to make a secure connection.'
  'scenes.login.upgrade.googleAuthVerify.header': 'Verify Your Google Account'
  'scenes.login.upgrade.googleAuthVerify.text': 'Enter the 6-digit code you see in your Google Auth App.'
  'scenes.login.upgrade.googleAuthVerify.input.placeholder': 'Tap Yubikey to enter code'
  'scenes.login.upgrade.googleAuthVerify.6digitcode': '6 Digit Code'
  'scenes.login.upgrade.googleAuthVerify.6digitcode.placeholder': 'Enter 6 digit code'
  'scenes.login.upgrade.yubikey.header': 'Verify with Your Yubikey'
  'scenes.login.upgrade.yubikey.text': 'Insert the Yubikey into your computer´s USB port. Pair your Yubikey by tapping your key.'
  'scenes.login.upgrade.yubikeyVerify.header': 'Yubikey Verified'
  'scenes.login.upgrade.yubikeyVerify.text': 'Make sure your Yubikey is plugged in next time you log into your Blockchain account.'
  'scenes.login.upgrade.2faSuccess.header': 'You’re All Set!'
  'scenes.login.upgrade.2faSuccess.text': 'Look for a confirmation email. You can now log in to the Wallet and Exchange with:'
  'scenes.login.upgrade.2faSuccess.new2fa': 'New 2FA'
  'scenes.login.upgrade.2faSuccess.footNote': 'You can now delete your old Exchange 2FA method.'
  'scenes.login.upgrade.2faSuccess.button': 'Open Exchange'
  ...
  'scenes.profile.identityverification.swaplimit.full_access_completeairdropeligible-1': 'By completing the Full Access requirements you are automatically eligible for our airdrop programs extended to your region.'
  ...
  'scenes.register.account_created': 'Account Created!'
  ...
  'scenes.register.selectproduct': 'Select a product to launch now.'
  ...
  'scenes.verifyemailtoken.return_mobile_new': 'Return to the app to access your Blockchain.com Wallet.'
  'scenes.verifyemailtoken.return_new': 'Return to the previous tab to access your Blockchain.com Wallet.'
