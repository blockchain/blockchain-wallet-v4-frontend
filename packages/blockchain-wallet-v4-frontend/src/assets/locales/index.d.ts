...
type MessagesType = {
  ...
  'buttons.close': 'Close'
  'buttons.confirm_withdrawal': 'Confirm Withdrawal'
  ...
  'modals.interest.agreement2': 'from your wallet to your Interest Account. A lock-up period of 7 days will be applied to your funds.'
  'modals.interest.calculator': 'Interest Calculator'
  'modals.interest.calculatordesc': 'With {currencySymbol}{depositAmount} in your Interest Account you could earn:'
  ...
  'modals.interest.sendinprogress.subtitle': 'Sending {displayName} to your Interest Account'
  'modals.interest.sendinprogress.title': 'In Progress...'
  ...
  'modals.interest.withdrawal.availability': 'Your {coin} will be available in your {coin} Wallet within 5 days.'
  'modals.interest.withdrawal.balance': 'Your {coin} Balance'
  'modals.interest.withdrawal.enteramount': 'Enter withdrawal amount'
  'modals.interest.withdrawal.fullamount': 'Full amount'
  'modals.interest.withdrawal.howmuch': 'How much do you want to withdraw?'
  'modals.interest.withdrawal.loading': 'Doing work...'
  'modals.interest.withdrawal.networkfee1': 'You are requesting to withdraw '
  'modals.interest.withdrawal.networkfee2': ' ({cryptoAmount}) from your Savings Wallet to your Interest Account, a network fee of {fee} {coin} will be applied.'
  ...
  'scenes.interest.earnbody.access': 'Upgrade to Gold Level and access benefits like earning up to {rate}% APY on your crypto.'
  'scenes.interest.earninfo.verified.body': 'Earn up to {rate}% AER instantly when you deposit {coin} to your Interest Account.'
  'scenes.interest.earnheaderverified': 'Earn interest on your Crypto today.'
  'scenes.interest.earnupgrade.header': 'Put your crypto to work by upgrading to Gold Level.'
  'scenes.interest.history.header': 'History'
  'scenes.interest.history.type': 'Type'
  'scenes.interest.interestaccount': 'Interest Account'
  'scenes.interest.userblocked': 'Blockchain Interest Account is currently unavailable in your country or region.'
  'scenes.interest.userblocked.bo': 'Blockchain Interest Account is currently not available.'
  'scenes.interest.summarycard.earn': 'Earn up to {interestRate}% AER on your {coinTicker}.'
  ...
  'scenes.interest.subheader': 'Deposit crypto and watch it grow without fees.'
