...
type MessagesType = {
  ...
  'modals.simplebuy.add_card.description': 'Securely add your card to fund the crypto buy. Buy with any Visa or Mastercard.'
  ...
  'modals.simplebuy.checkout.larger_amount.info1': 'Getting up to {symbol}{amount} per transaction with card is the <b>fastest way to buy crypto</b>, it only takes a few minutes.'
  'modals.simplebuy.checkout.larger_amount.info2': 'To buy larger amounts and unlock more payment methods you need to become Gold level and verify your identity.'
  ...
  'modals.simplebuy.transferdetails.bit_coin_available': 'Your Bitcoin is now available in your Trading Wallet.'
