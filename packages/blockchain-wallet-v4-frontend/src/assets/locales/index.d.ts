...
type MessagesType = {
  ...
  'modals.onboarding.linkfromexchange.conflict_subtitle': 'Your Wallet and Exchange accounts are now linked, but there are some discrepancies between your profiles.'
  'modals.onboarding.linkfromexchange.conflict_subtitle_caption': 'Help us resolve by filling out the below form:'
