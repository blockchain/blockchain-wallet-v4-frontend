...
type MessagesType = {
  ...
  'mdoals.interest.privacy': 'Privacy'
  ...
  'modals.interest.agreement1': 'By accepting this, you agree to transfer'
  'modals.interest.agreement2': 'from your Bitcoin Vault Wallet to your Savings Wallet. A lock-up period of 30 days will be applied to your funds.'
  'modals.interest.calculator': 'Interest Calculator'
  'modals.interest.calculatordesc': 'With {savingsAmount} in your Savings Wallet you would earn:'
  'modals.interest.candeposit': 'You can deposit up to'
  'modals.interest.confirmdeposit': 'Confirm Deposit'
  ...
  'modals.interest.longterm': 'Long-term'
  'modals.interest.longterm.fiveyears': '5 Years'
  'modals.interest.longterm.threeyear': '3 Years'
  'modals.interest.longterm.year': 'Year'
  'modals.interest.shortterm': 'Short-term'
  'modals.interest.shortterm.daily': 'Daily'
  'modals.interest.shortterm.monthly': 'Monthly'
  'modals.interest.shortterm.weekly': 'Weekly'
  ...
  'scenes.faq.group.walletfunctionality.answer1.one.updated': 'To receive funds, the sender needs your address. Your wallet will automatically generate a new address for each bitcoin or bitcoin cash transaction you make. For all ether, stellar, or USD Digital transactions, your address will remain the same.'
  ...
  'scenes.faq.group.walletfunctionality.answer10.three': 'Since your funds in these addresses are not backed up in your recovery phrase, we strongly recommend ‘transferring’ any funds from these addresses into your main accounts. In the past, you may have seen these accounts labelled ’watch-only’. In response to scams taking place due to lack of knowledge about the feature, we changed the label to ’non-spendable’ for clarity’s sake.'
  'scenes.faq.group.walletfunctionality.answer10.two': 'Non-spendable addresses are a useful feature to monitor incoming and outgoing transactions or to keep track of an address for repeated payments like rent. Keep in mind that sending and receiving to the same address makes your transaction history easy to trace. Alternatively, you can import a private key from a different wallet provider (which has your public key attached) and spend from it freely within your Blockchain wallet.'
  ...
  'scenes.faq.group.walletfunctionality.answer11.link': 'https://www.blockchain.com/explorer'
  ...
  'scenes.faq.group.walletfunctionality.answer13': 'USD Digital is a cryptocurrency pegged to the U.S. dollar and issued by the Paxos Trust Company, a company organized under New York State banking law. USD Digital functions as a digital dollar - giving you instant liquidity in your wallet and a place to store stable value.'
  'scenes.faq.group.walletfunctionality.answer14': 'USD Digital is built on the Ethereum blockchain following the ERC-20 protocol. For this reason, digital dollars can be sent to or received by anyone with an Ethereum wallet (such as your Blockchain Wallet) for a small miners fee.'
  'scenes.faq.group.walletfunctionality.answer15': 'USD Digital is regulated by the NY State Dept. of Financial Services which ensures all holdings of PAX are mirrored one-to-one for USD. Digital dollars are only in existence when the corresponding U.S dollars are in custody, which keeps the price stable at precisely $1.00.'
  'scenes.faq.group.walletfunctionality.answer16': 'Although the price of USD Digital is pegged to USD, USD Digital remains a cryptocurrency token hosted on the Ethereum blockchain. For this reason, it must be exchanged for USD before your balance can be transferred to a bank account. You can do this through any exchange that supports the Paxos Standard Token (PAX).'
  ...
  'scenes.faq.group.walletfunctionality.question10': 'What is a non-spendable address?'
  ...
  'scenes.faq.group.walletfunctionality.question13': 'What is USD Digital and how does it differ from the other cryptocurrencies in my wallet?'
  'scenes.faq.group.walletfunctionality.question14': 'Why do I need a small amount of ETH to send or exchange PAX?'
  'scenes.faq.group.walletfunctionality.question15': 'How does USD Digital remain stable?'
  'scenes.faq.group.walletfunctionality.question16': 'How do I get USD Digital into my bank account?'
  ...
  'scenes.interest.earninterest': 'Earn Interest'
  'scenes.interest.subheader': 'Deposit crypto and instantly earn interest with absolutely no fees.'
