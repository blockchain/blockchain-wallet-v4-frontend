...
const DEFAULT_CARD_MIN = 13
export const DEFAULT_CARD_FORMAT = /(\d{1,4})/g
const DEFAULT_CARD_SVG_LOGO =
...
const DEFAULT_SECURITY_CODE_NAME = 'CVC'
...
const CARD_DEFAULTS = {
  ...
  maxCardNumberLength: DEFAULT_CARD_MAX,
