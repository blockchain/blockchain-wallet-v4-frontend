              ...
              {isLimitError(props.error) && props.userData?.tiers?.current < 2 ? (
                ...
                >
                  <>
                    ...
                    <br />
                    <FormattedMessage id='copy.upgrade' defaultMessage='Upgrade To Full Access' />
                  </>
                </div>
              ) : (
                <ErrorCodeMappings code={props.error} />
            ...
            <ButtonContainer>
              ...
              >
                ...
                {(amtError === 'ABOVE_LIMIT' ||
                  (amtError === 'ABOVE_BALANCE' && !isFundsMethod)) && (
                  <FormattedMessage
                    id='modals.simplebuy.checkout.buy.over_limit_full'
                    defaultMessage='You can buy up to {amount} per transaction. Upgrade to Full Access & buy larger amounts with your bank or card.'
                    values={{
                      amount:
                        fix === 'FIAT'
                          ? fiatToString({ unit: props.fiatCurrency, value: max })
