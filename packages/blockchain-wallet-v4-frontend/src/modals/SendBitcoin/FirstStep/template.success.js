...
import { shouldValidate, isAddressDerivedFromPriv, insufficientFunds, minimumAmount, maximumAmount, minimumFeePerByte, maximumFeePerByte } from './validation'
    ...
    <Form onSubmit={handleSubmit}>
      ...
      <FormGroup margin={'15px'}>
        <FormItem>
          ...
          <Field name='amount' component={FiatConvertor} validate={[required, insufficientFunds, minimumAmount, maximumAmount]} coin='BTC' />
        </FormItem>
      </FormGroup>
      <FormGroup margin={'15px'}>
        <FormItem>
