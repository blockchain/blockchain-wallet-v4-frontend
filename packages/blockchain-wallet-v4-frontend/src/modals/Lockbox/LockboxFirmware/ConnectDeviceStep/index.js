...
class ConnectDeviceContainer extends React.PureComponent {
  ...
  render() {
    return <CheckForUpdatesStep {...this.props} retryConnection={this.retryConnection} />
  }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(ConnectDeviceContainer)
