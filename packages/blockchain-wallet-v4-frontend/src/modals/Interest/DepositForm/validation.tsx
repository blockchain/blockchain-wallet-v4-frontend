...
export const minDepositAmount = (value, allValues, props: Props) => {
  ...
  const minDeposit = props.displayCoin ? props.depositLimits.minCoin : props.depositLimits.minFiat
...
export const maxDepositAmount = (value, allValues, props: Props) => {
  if (!value) return true
  const maxDeposit = props.displayCoin ? props.depositLimits.maxCoin : props.depositLimits.maxFiat
