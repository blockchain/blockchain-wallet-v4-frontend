    ...
    <Modal size='large' position={position} total={total}>
      <Form onSubmit={handleSubmit}>
        ...
        <ModalBody>
          ...
          <Container>
            {indexes.indexOf(0) > -1 && (
              <WordInput index={0} mnemonic={mnemonic} />
            )}
            {indexes.indexOf(1) > -1 && (
              <WordInput index={1} mnemonic={mnemonic} />
            )}
            {indexes.indexOf(2) > -1 && (
              <WordInput index={2} mnemonic={mnemonic} />
            )}
            {indexes.indexOf(3) > -1 && (
              <WordInput index={3} mnemonic={mnemonic} />
            )}
            {indexes.indexOf(4) > -1 && (
              <WordInput index={4} mnemonic={mnemonic} />
            )}
            {indexes.indexOf(5) > -1 && (
              <WordInput index={5} mnemonic={mnemonic} />
            )}
            {indexes.indexOf(6) > -1 && (
              <WordInput index={6} mnemonic={mnemonic} />
            )}
            {indexes.indexOf(7) > -1 && (
              <WordInput index={7} mnemonic={mnemonic} />
            )}
            {indexes.indexOf(8) > -1 && (
              <WordInput index={8} mnemonic={mnemonic} />
            )}
            {indexes.indexOf(9) > -1 && (
              <WordInput index={9} mnemonic={mnemonic} />
            )}
            {indexes.indexOf(10) > -1 && (
              <WordInput index={10} mnemonic={mnemonic} />
            )}
            {indexes.indexOf(11) > -1 && (
              <WordInput index={11} mnemonic={mnemonic} />
            )}
          </Container>
        </ModalBody>
