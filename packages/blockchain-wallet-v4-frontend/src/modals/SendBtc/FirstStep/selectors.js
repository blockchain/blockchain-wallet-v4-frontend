...
export const getData = state => {
  ...
  const coin = formValueSelector('sendBtc')(state, 'coin')
  const from = formValueSelector('sendBtc')(state, 'from')
  const to = formValueSelector('sendBtc')(state, 'to') || formValueSelector('sendBtc')(state, 'to2')
  const fee = formValueSelector('sendBtc')(state, 'fee')
  const amount = formValueSelector('sendBtc')(state, 'amount')
