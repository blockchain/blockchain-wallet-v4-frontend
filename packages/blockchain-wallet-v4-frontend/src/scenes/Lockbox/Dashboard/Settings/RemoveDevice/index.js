...
class RemoveDeviceContainer extends React.PureComponent {
  ...
  render() {
    ...
    return <DeviceStatus deleteDevice={this.deleteDevice} deviceName={deviceName} />
  }
}
...
export default connect(mapStateToProps, mapDispatchToProps)(RemoveDeviceContainer)
