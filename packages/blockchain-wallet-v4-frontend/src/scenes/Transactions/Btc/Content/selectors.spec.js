  ...
  describe('getData', () => {
    it('should return the correct transaction(s)', () => {
            ...
            btc: {
              getWalletTransactions: [{
                data: [
                  {
                    amount: 123456,
                    hash: '8ba8eb225e18a484871aee5787db4394bb29bccd1ebccb23a572f76eb38dad25',
                    type: 'received',
                  ...
                  {
                    amount: 35215,
                    hash: 'asdfjl245uy2ljflj2r082347892jlkaoquvnx,3e8402157fhvlsieuro23r235',
                    type: 'sent',
      ...
      expect(selected.pages).toEqual([
        {
          data:
            [mockParams.core.common.btc.getWalletTransactions[0].data[0]]
        }
      ])
