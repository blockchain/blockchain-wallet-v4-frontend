...
import { BuyOrSell, displayFiat } from 'blockchain-wallet-v4-frontend/src/modals/BuySell/model'
...
`
class BuySellListItem extends PureComponent<Props, State> {
...
export default connector(BuySellListItem)
