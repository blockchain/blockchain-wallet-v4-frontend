...
class ManageAddressesContainer extends React.Component {
  render () {
    let { account, labels, receiveIndex, isDefault, coreActions, walletActions, modalsActions } = this.props
    ...
    let props = { account, labels, receiveIndex, isDefault, deriveAddress, onSetLabel, onEditLabel, onDeleteLabel, onEditAccountLabel, onShowXPub, onMakeDefault }
