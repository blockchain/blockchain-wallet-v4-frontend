...
const ExchangeConfirm = ({
  ...
  <ConfirmForm onSubmit={handleSubmit}>
    ...
    <ExchangeButton type='submit' nature='primary' disabled={submitting} data-e2e='exchangeCompleteOrderButton'>
      {!submitting && (
        <FormattedMessage
    ...
    <CancelButton disabled={submitting} onClick={onBack} data-e2e='exchangeCancelOrderButton'>
      {!submitting && (
        <FormattedMessage
