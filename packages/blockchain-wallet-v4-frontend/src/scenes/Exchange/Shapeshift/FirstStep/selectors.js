...
export const getData = state => {
  ...
  if (equals('BTC', sourceCoin) && equals('ETH', targetCoin)) {
    return lift((btcEth, btcRates, ethRates) => ({ btcEth, btcRates, ethRates }))(btcEthR, btcRatesR, ethRatesR)
  }
  if (equals('ETH', sourceCoin) && equals('BTC', targetCoin)) {
    return lift((ethBtc, btcRates, ethRates) => ({ ethBtc, btcRates, ethRates }))(ethBtcR, btcRatesR, ethRatesR)
  }
}
