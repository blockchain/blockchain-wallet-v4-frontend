  ...
  describe('getData', () => {
    it('should return the correct transaction(s)', () => {
      ...
      const selected = getData.resultFunc(
        mockParams.form.bchTransactions,
        mockParams.core.common.bch.getWalletTransactions,
        mockParams.core.kvStore.buySell.getMetaData
      )

      expect(selected.pages).toEqual([
        {
          data: [mockParams.core.common.bch.getWalletTransactions[0].data[0]]
        }
      ])
