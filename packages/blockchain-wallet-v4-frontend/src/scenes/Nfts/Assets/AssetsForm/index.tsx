...
const NftAssetsForm: React.FC<Props> = (props: Props) => {
        ...
        <FormWrapper>
          ...
          >
            <Field
              ...
              name='collection'
              value='all'
              onChange={() => props.formActions.change('assetsForm', 'collection', 'all')}
            />
          ...
          {collections.map((collection) => (
            ...
            >
              <Field
                ...
                onChange={() =>
                  props.formActions.change('assetsForm', 'collection', collection.slug)
                }
              />
