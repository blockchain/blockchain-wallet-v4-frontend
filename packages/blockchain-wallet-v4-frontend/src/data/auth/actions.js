...
export const register = (email, password, language) => ({ type: AT.REGISTER, payload: { email, password, language } })
...
export const resendSmsCode = (guid) => ({ type: AT.RESEND_SMS_CODE, payload: { guid } })
...
export const restore = (mnemonic, email, password, language, network) => ({ type: AT.RESTORE, payload: { mnemonic, email, password, language, network } })
