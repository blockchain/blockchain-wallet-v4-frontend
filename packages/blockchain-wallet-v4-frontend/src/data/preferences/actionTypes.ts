export const HIDE_AIRDROP_CLAIM_MODAL =
  '@DATA.PREFERENCES.HIDE_AIRDROP_CLAIM_MODAL'
...
export const HIDE_LOCKBOX_SOFTWARE_DOWNLOAD =
  '@DATA.HIDE_LOCKBOX_SOFTWARE_DOWNLOAD'
export const HIDE_NONE_OR_GOLD_BANNER =
  '@DATA.PREFERENCES.HIDE_NONE_OR_GOLD_BANNER'
export const HIDE_SWAP_BANNER = '@DATA.PREFERENCES.HIDE_SWAP_BANNER'
export const HIDE_SWAP_INFO_BANNER = '@DATA.PREFERENCES.HIDE_SWAP_INFO_BANNER'
