...
export const isOnfidoEnabled = path(['components', 'identityVerification', 'onfidoEnabled'])
export const getStep = path(['components', 'identityVerification', 'step'])
export const getPersonalStep = path(['components', 'identityVerification', 'personalStep'])
export const getEmailStep = path(['components', 'identityVerification', 'emailStep'])
export const getSmsStep = path(['components', 'identityVerification', 'smsStep'])
