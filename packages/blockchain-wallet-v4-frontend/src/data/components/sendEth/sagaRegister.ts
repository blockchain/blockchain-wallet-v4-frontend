...
export default ({ api, coreSagas, networks }) => {
  ...
  return function* sendEthSaga() {
    ...
    yield takeLatest(AT.SEND_ETH_FIRST_STEP_REGULAR_FEE_CLICKED, sendEthSagas.regularFeeClicked)
    ...
    yield takeLatest(AT.SEND_ETH_UPDATE_TO, sendEthSagas.updateTo)
  }
}
