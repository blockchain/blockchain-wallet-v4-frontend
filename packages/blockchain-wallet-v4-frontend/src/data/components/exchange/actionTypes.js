...
export const CHANGE_SOURCE_AMOUNT = '@EVENT.EXCHANGE.CHANGE_SOURCE_AMOUNT'
export const CHANGE_TARGET_AMOUNT = '@EVENT.EXCHANGE.CHANGE_TARGET_AMOUNT'
export const CHANGE_SOURCE_FIAT_AMOUNT =
  '@EVENT.EXCHANGE.CHANGE_SOURCE_FIAT_AMOUNT'
export const CHANGE_TARGET_FIAT_AMOUNT =
  '@EVENT.EXCHANGE.CHANGE_TARGET_FIAT_AMOUNT'
