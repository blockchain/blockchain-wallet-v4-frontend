...
export default ({ api, coreSagas }) => {
  ...
  return function * () {
    yield takeLatest(AT.EXCHANGE_HISTORY_INITIALIZED, exchangeHistorySagas.exchangeHistoryInitialized)
    yield takeLatest(AT.EXCHANGE_HISTORY_DESTROYED, exchangeHistorySagas.exchangeHistoryDestroyed)
