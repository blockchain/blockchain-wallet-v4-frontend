...
export default ({ coreSagas }) => {
  ...
  return function* () {
    ...
    yield takeLatest(AT.SHOW_GOOGLE_AUTHENTICATOR_SECRET_URL, settingsSagas.showGoogleAuthenticatorSecretUrl)
    ...
    yield takeLatest(AT.ENABLE_TWO_STEP_GOOGLE_AUTHENTICATOR, settingsSagas.enableTwoStepGoogleAuthenticator)
