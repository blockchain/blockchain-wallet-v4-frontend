...
export default ({ coreSagas }) => {
  ...
  return function * () {
    ...
    yield takeLatest(AT.GET_GOOGLE_AUTHENTICATOR_SECRET_URL, securityCenterSagas.getGoogleAuthenticatorSecretUrl)
    ...
    yield takeLatest(AT.SEND_MOBILE_VERIFICATION_CODE, securityCenterSagas.sendMobileVerificationCode)
    ...
    yield takeLatest(AT.SET_VERIFIED_MOBILE_AS_TWO_FACTOR, securityCenterSagas.setVerifiedMobileAsTwoFactor)
  }
}
