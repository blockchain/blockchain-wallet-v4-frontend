...
export const GUID_SENT_ERROR = 'guid_sent_error'
export const GUID_SENT_SUCCESS = 'guid_sent_success'
...
export const MOBILE_LOGIN_ERROR_QRCODE_EXPIRED =
  'mobile_login_error_qrcode_expired'
