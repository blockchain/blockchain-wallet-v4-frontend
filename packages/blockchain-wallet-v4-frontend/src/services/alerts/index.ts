...
export const TRADING_CURRENCY_UPDATE_SUCCESS = 'trading_currency_update_success'
export const TRADING_CURRENCY_UPDATE_ERROR = 'trading_currency_update_error'
...
export const DEVICE_MISMATCH = 'device_mismatch'
...
export const MAGIC_LINK_PARSE_ERROR = 'magic_link_parse_error'
...
export const MOBILE_LOGIN_CONFIRM = 'mobile_login_confirm'
export const MOBILE_LOGIN_DECLINED = 'mobile_login_declined'
...
export const RECOVERY_EMAIL_SENT_ERROR = 'recovery_email_sent_error'
...
export const TWOFA_VERIFIED = 'twofa_verified'
...
export const VERIFY_DEVICE_EXPIRY = 'verify_device_expiry'
export const VERIFY_DEVICE_FAILED = 'verify_device_failed'
...
export const UPLOAD_ADDITIONAL_DOCUMENTS_FILES_ERROR = 'upload_additional_documents_files_error'
