...
export const TWOFA_RESET_UNKNOWN_GUID_ERROR = 'twofa_reset_unknown_guid_error'
export const TWOFA_RESET_NOT_ENABLED_ERROR = 'twofa_reset_not_enabled_error'
export const TWOFA_RESET_EMAIL_ERROR = 'twofa_reset_email_error'
export const TWOFA_RESET_ERROR = 'twofa_reset_error'
