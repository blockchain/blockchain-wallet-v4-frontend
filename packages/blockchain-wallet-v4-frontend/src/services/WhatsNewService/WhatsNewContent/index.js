...
export const filterAnnouncements = (lastViewed, userCountry, userKycState) => {
  const isOnRestrictedCountryList = restrictedCountryList =>
    restrictedCountryList.indexOf(userCountry) > -1
  const isOnRestrictedKycList = restrictedKycList =>
    restrictedKycList.indexOf(userKycState) > -1
