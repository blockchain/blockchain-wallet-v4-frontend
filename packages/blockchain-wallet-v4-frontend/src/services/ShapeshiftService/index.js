...
export const getCoinFromPair = pair => {
  switch (pair) {
    case 'btc_eth':
      return { sourceCoin: 'BTC', targetCoin: 'ETH' }
    case 'btc_bch':
      return { sourceCoin: 'BTC', targetCoin: 'BCH' }
    case 'bch_btc':
      return { sourceCoin: 'BCH', targetCoin: 'BTC' }
    case 'bch_eth':
      return { sourceCoin: 'BCH', targetCoin: 'ETH' }
    case 'eth_btc':
      return { sourceCoin: 'ETH', targetCoin: 'BTC' }
    case 'eth_bch':
      return { sourceCoin: 'ETH', targetCoin: 'BCH' }
    default:
      return { sourceCoin: '', targetCoin: '' }
  }
}
