...
const FaqContent = [
  {
    ...
    groupQuestions: [{
      ...
      question: <FormattedMessage id='scenes.faq.group.walletfunctionality.question4' defaultMessage={'What is the difference between a wallet ID and an address?'} />,
      answer: <FormattedMessage id='scenes.faq.group.walletfunctionality.answer4' defaultMessage={'You can think of your wallet ID as a username that contains numbers, letters, and dashes. It is only used to log into your wallet and should be kept private. Your wallet ID can be found in the welcome email we sent you when you created your wallet or in Settings -> General. Addresses are what you share with others when you want to receive funds. To find your bitcoin, ether, or bitcoin cash address click on ‘Request’.'} />
    }, {
