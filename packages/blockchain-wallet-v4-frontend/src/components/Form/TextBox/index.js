...
const TextBox = (field) => {
  ...
  return (
    <Container>
      <TextInput {...field.input} autoComplete={field.autoComplete} borderRightNone={field.borderRightNone} disabled={field.disabled} errorState={errorState} initial={field.meta.initial} placeholder={field.placeholder} center={field.center} />
