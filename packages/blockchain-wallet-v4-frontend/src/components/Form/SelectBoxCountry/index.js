...
class SelectBoxCountry extends React.PureComponent {
  ...
  render () {
    ...
    const elements = [{ group: '', items: applyWhiteBlackList(whiteList, blackList)(countries) }]
...
export const whiteBlackListsConflictMessage = 'Cannot use both blacklist and whitelist in SelectBoxCountry component'
...
const applyWhiteBlackList = (whiteList, blackList) => {
  ...
  return cond([
    [() => blackList && !isEmpty(blackList), filter(({ value }) => !contains(value, blackList))],
