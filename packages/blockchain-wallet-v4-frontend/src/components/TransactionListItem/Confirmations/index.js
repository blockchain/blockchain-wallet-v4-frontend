      ...
      <IconWrapper>
        {
          props.confirmations < props.minConfirmations && <TransactionTooltip>
            <Tooltip>
              <FormattedMessage id='scenes.transactions.bitcoin.content.list.listitem.transaction_unconfirmed' defaultMessage='Your transaction will be complete after it has {minConfirmations} confirmations.' values={{minConfirmations: props.minConfirmations}} />
