...
export const MenuItem = styled.button<{ colorCode?: keyof DefaultTheme }>`
  ...
  &.coin {
    ...
    &:hover {
      background: ${props =>
        props.colorCode && (props.colorCode === 'wdgld' ? props.theme.grey000 : transparentize(0.85, props.theme[props.colorCode]))};
      .destination {
        color: ${props => props.theme.grey600};
      }
    }
    ...
    &:active {
      background: ${props =>
        props.colorCode && (props.colorCode === 'wdgld' ? props.theme.grey000 : transparentize(0.75, props.theme[props.colorCode]))};
      .destination {
