    ...
    before(app) {
      app.get('/Resources/wallet-options-v4.json', function(req, res) {
        ...
        mockWalletOptions.domains = {
          ...
          apiWebSocket: envConfig.API_WEB_SOCKET_URL,
      ...
      'Content-Security-Policy': isCiBuild
        ...
        : [
            ...
            [
              ...
              'ws://localhost:8080',
              'wss://localhost:8080',
              `${envConfig.WEB_SOCKET_URL}/inv`,
              `${envConfig.WEB_SOCKET_URL}/eth/inv`,
              `${envConfig.WEB_SOCKET_URL}/bch/inv`,
              `${envConfig.API_WEB_SOCKET_URL}`,
              envConfig.ROOT_URL,
