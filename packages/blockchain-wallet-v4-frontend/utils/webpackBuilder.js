  ...
  return {
    ...
    headers: {
      ...
      'Content-Security-Policy': [
        ...
        `frame-src http://localhost:8081 ${envConfig.EVERYPAY_URL} ${envConfig.WALLET_HELPER_DOMAIN} ${envConfig.ROOT_URL} https://magic.veriff.me https://localhost:8080 http://localhost:8080`,
