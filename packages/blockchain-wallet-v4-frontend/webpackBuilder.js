    ...
    headers: {
      ...
      'Content-Security-Policy': [
        ...
        [
          ...
          "'self'",
          'data:',
          `https://firebaseinstallations.googleapis.com/v1/projects/${process.env.FIREBASE_PROJECT_ID}`,
          `https://firebaseremoteconfig.googleapis.com/v1/projects/${process.env.FIREBASE_PROJECT_ID}`,
