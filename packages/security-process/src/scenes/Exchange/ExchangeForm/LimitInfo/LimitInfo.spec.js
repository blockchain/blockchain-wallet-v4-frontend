...
describe('Profile Settings', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render "Silver - In Review" if Tier 1 is PENDING and next is 1', () => {
      ...
      expect(wrapper.text().trim()).toBe('Silver -  In Review')
    })

    it('should render "Silver - In Review" and "Upgrade" if Tier 1 is PENDING and next is 2', () => {
      const userTiers = {
        current: 0,
        selected: 1,
        next: 2
      ...
      expect(wrapper.text().trim()).toBe('Silver -  In Review Upgrade')
    })

    it('should render "Gold - In Review" if Tier 1 is REJECTED and Tier 2 is PENDING', () => {
      const userTiers = {
        current: 0,
        selected: 2,
        next: 2
      ...
      expect(wrapper.text().trim()).toBe('Gold -  In Review')
    })
    ...
    it('should render "In Review - Documents Needed" if Tier 1 is REJECTED and Tier 2 is NONE', () => {
      ...
      expect(wrapper.text().trim()).toBe(
        'Silver -  In Review - Documents Needed Continue'
      )
    ...
    it('should render Tier 1 limit and "Upgrade" if Tier 1 is VERIFIED and Tier 2 is NONE', () => {
      ...
      expect(wrapper.text().trim()).toBe(
        'Silver -  $1,000.00 Available Upgrade'
      )
    ...
    it('should render Tier 1 limit and if Tier 1 is VERIFIED and Tier 2 is REJECTED', () => {
      ...
      expect(wrapper.text().trim()).toBe('Silver -  $1,000.00 Available')
    })
    ...
    it('should render Tier 1 limit and "In Review" if Tier 1 is VERIFIED and Tier 2 is PENDING', () => {
      ...
      expect(wrapper.text().trim()).toBe(
        'Silver -  $1,000.00 Available Gold In Review'
      )
    })
    ...
    it('should render Tier 2 limit if Tier 2 is VERIFIED', () => {
      ...
      expect(wrapper.text().trim()).toBe('Gold -  $10,000.00 Available')
    })
  })
})
