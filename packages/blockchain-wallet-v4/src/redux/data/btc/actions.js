...
export const fetchDataSuccess = data => ({
  type: AT.FETCH_BITCOIN_DATA_SUCCESS,
  payload: data
})
export const fetchDataFailure = error => ({
  type: AT.FETCH_BITCOIN_DATA_FAILURE,
  payload: error
})
...
export const fetchTransactionHistory = (address, start, end) => ({
  type: AT.FETCH_BITCOIN_TRANSACTION_HISTORY,
  payload: { address, start, end }
})
export const fetchTransactionHistoryLoading = () => ({
  type: AT.FETCH_BITCOIN_TRANSACTION_HISTORY_LOADING
})
export const fetchTransactionHistorySuccess = data => ({
  type: AT.FETCH_BITCOIN_TRANSACTION_HISTORY_SUCCESS,
  payload: data
})
export const fetchTransactionHistoryFailure = error => ({
  type: AT.FETCH_BITCOIN_TRANSACTION_HISTORY_FAILURE,
  payload: error
})
export const clearTransactionHistory = () => ({
  type: AT.CLEAR_BITCOIN_TRANSACTION_HISTORY
})
