...
export const getSpendableContext = compose(ImtoJS, Wallet.selectSpendableContext, getWallet)
export const getUnspendableContext = compose(ImtoJS, Wallet.selectUnspendableContext, getWallet)
