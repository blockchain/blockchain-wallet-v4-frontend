import { compose, curry, find, head, findIndex, propEq, path, prop } from 'ramda'
...
export const getLatestTransaction = (state) => getMetadata(state).map(path(['value', 'ethereum', 'last_transaction_timestamp']))
