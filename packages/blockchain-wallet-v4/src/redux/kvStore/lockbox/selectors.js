...
export const getLockboxBtc = (state) =>
  getDevices(state).map(map(path(['btc'])))
...
// BCH
export const getLockboxBch = (state) =>
  getDevices(state).map(map(path(['bch'])))
...
// ETH
export const getLockboxEth = (state) =>
  getDevices(state).map(map(path(['eth'])))
