...
describe('Address', () => {
  ...
  describe('serializer: ', () => {
    it('compose(reviver, replacer) should be identity', () => {
      ...
      //   console.log(k instanceof Map)
      //   return v
      // }
      // const my = Map({una: 1, dos: 2})
      console.log('=======================')
      // console.log(JSON.stringify(my, i))
      console.log(JSON.stringify(address))
      console.log(Address.toJS(address))
      // const a = JSON.stringify(address, i)
      // console.log(Address.setLabel('holaaaa')(address))
      // console.log(address instanceof Map)
      // console.log(address instanceof Address.Address)
      // console.log(a)
